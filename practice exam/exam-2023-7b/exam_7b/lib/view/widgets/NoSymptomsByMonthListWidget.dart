...
class NoSymptomsByMonthListWidget extends StatefulWidget {
  const NoSymptomsByMonthListWidget({super.key});

  @override
  State<StatefulWidget> createState() => _NoSymptomsByMonthListWidget();
}

class _NoSymptomsByMonthListWidget extends State<NoSymptomsByMonthListWidget> {
  Widget _buildListView() {
    var entitiesFuture =
    Provider.of<DbRepository>(context, listen: true).getNoSymptomsByMonth();
