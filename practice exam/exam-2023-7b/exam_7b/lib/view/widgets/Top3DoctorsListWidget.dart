...
class Top3DoctorsListWidget extends StatefulWidget {
  const Top3DoctorsListWidget({super.key});

  @override
  State<StatefulWidget> createState() => _Top3DoctorsListWidget();
}

class _Top3DoctorsListWidget extends State<Top3DoctorsListWidget> {
  Widget _buildListView() {
    var entitiesFuture =
    Provider.of<DbRepository>(context, listen: true).getTop3Doctors();
