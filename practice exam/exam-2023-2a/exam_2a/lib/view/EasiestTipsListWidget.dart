import 'package:exam_2a/view/ChangeDifficultyPage.dart';
...
class EasiestTipsListWidget extends StatefulWidget {
  const EasiestTipsListWidget({super.key});

  @override
  State<StatefulWidget> createState() => _EasiestTipsListWidget();
}

class _EasiestTipsListWidget extends State<EasiestTipsListWidget> {
  Widget _buildListView() {
    var entitiesFuture =
        Provider.of<DbRepository>(context, listen: true).getTop10EasiestTips();
                  ...
                  child: ListTile(
                    ...
                    onTap: () => {
                      Navigator.of(context)
                        ...
                        return ChangeDifficultyPage(entity);
                      }))
                    },
                  ),
                );
